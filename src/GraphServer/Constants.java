...
public class Constants 
{
	...
	public static final int START_GAME_DELAY = 114;
	
	public static final int TURN_TIME = 60000; // 仅客户端生效...
	...
	public static final String[] computerNames = {"深度思考", "硬件抽象层", "天网", "史密斯助理", "超级计算机", "深蓝", "聪明机器人", "阿尔法·佐登", "沃尔夫勒姆"};
